...
export default function App() {
  ...
  const tabItems = [
    ...
    { id: "steps", label: "11단계 보상투어", icon: Milestone, color: "text-emerald-500" },
    { id: "simulator", label: "점수 시뮬레이션", icon: Calculator, color: "text-teal-500" },
    { id: "vs", label: "1BC vs 3BC 비법", icon: Scale, color: "text-blue-500" },
  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen flex flex-col antialiased font-sans">
      ...
      {/* 프리미엄 헤더 */}
      <Header onConsultingClick={() => displayToast("💬 카카오톡 1:1 컨설팅으로 실시간 연결됩니다!")} />
