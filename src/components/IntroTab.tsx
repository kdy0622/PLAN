    ...
    <div className="space-y-6">
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group bg-white hover:bg-teal-50/10 border border-slate-200 hover:border-teal-300 p-4 rounded-2xl shadow-sm text-center transition-all flex flex-col justify-between"
        >
          <div>
            <span className="text-3xl block mb-1 group-hover:scale-105 transition-transform">💬</span>
            <h4 className="text-xs sm:text-sm font-black text-slate-900">1:1문의</h4>
            <p className="text-slate-500 text-[10px] sm:text-xs mt-1 leading-normal">
              카카오톡 오픈챗으로 나만의 성격에 맞는 소득 맵을 진단받으세요.
            </p>
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group bg-white hover:bg-sky-50/10 border border-slate-200 hover:border-sky-300 p-4 rounded-2xl shadow-sm text-center transition-all flex flex-col justify-between"
        >
          <div>
            <span className="text-3xl block mb-1 group-hover:scale-105 transition-transform">📝</span>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group bg-white hover:bg-indigo-50/10 border border-slate-200 hover:border-indigo-300 p-4 rounded-2xl shadow-sm text-center transition-all flex flex-col justify-between"
        >
          <div>
            <span className="text-3xl block mb-1 group-hover:scale-105 transition-transform">✨</span>
            <h4 className="text-xs sm:text-sm font-black text-slate-900">유사나 알아보기</h4>
            <p className="text-slate-500 text-[10px] sm:text-xs mt-1 leading-normal">
              공식 종합 정보 채널에서 압도적인 제품 기술력을 확인하세요.
            </p>
          </div>
